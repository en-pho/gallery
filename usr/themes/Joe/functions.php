<?php
if (!defined('__Snowfox_ROOT_DIR__')) exit;
...
?>
  <link rel="stylesheet" href="<?php _getAssets('assets/Snowfox/config/css/joe.config.min.css') ?>">
  <script src="<?php _getAssets('assets/Snowfox/config/js/joe.config.min.js') ?>"></script>
  ...
  <?php
  $JFavicon = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JFavicon',
    NULL,
  ...
  $JLogo = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JLogo',
    NULL,
  ...
  $JAssetsURL = new Snowfox_Widget_Helper_Form_Element_Text(
    'JAssetsURL',
    NULL,
    NULL,
    '自定义静态资源CDN地址（非必填）',
    '介绍：自定义静态资源CDN地址，不填则走本地资源 <br />
     ...
     2. 填写静态资源地址访问的前缀 <br />
     3. 例如：https://npm.elemecdn.com/Snowfox-joe-latest'
  );
  $JAssetsURL->setAttribute('class', 'joe_content joe_global');
  $form->addInput($JAssetsURL);

  $JCommentStatus = new Snowfox_Widget_Helper_Form_Element_Select(
    'JCommentStatus',
    array(
      'on' => '开启（默认）',
      'off' => '关闭'
  ...
  $JNavMaxNum = new Snowfox_Widget_Helper_Form_Element_Select(
    'JNavMaxNum',
    array(
      '3' => '3个（默认）',
      '4' => '4个',
  ...
  $JCustomNavs = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JCustomNavs',
    NULL,
    NULL,
    '导航栏自定义链接（非必填）',
  ...
  $JList_Animate = new Snowfox_Widget_Helper_Form_Element_Select(
    'JList_Animate',
    array(
      'off' => '关闭（默认）',
      'bounce' => 'bounce',
  ...
  $JFooter_Left = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JFooter_Left',
    NULL,
  ...
  $JFooter_Right = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JFooter_Right',
    NULL,
  ...
  $JDocumentTitle = new Snowfox_Widget_Helper_Form_Element_Text(
    'JDocumentTitle',
    NULL,
    NULL,
    '网页被隐藏时显示的标题',
  ...
  $JCursorEffects = new Snowfox_Widget_Helper_Form_Element_Select(
    'JCursorEffects',
    array(
      'off' => '关闭（默认）',
      'cursor1.js' => '效果1',
  ...
  $JCustomCSS = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JCustomCSS',
    NULL,
    NULL,
    '自定义CSS（非必填）',
  ...
  $JCustomScript = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JCustomScript',
    NULL,
    NULL,
    '自定义JS（非必填）',
  ...
  $JCustomHeadEnd = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JCustomHeadEnd',
    NULL,
    NULL,
  ...
  $JCustomBodyEnd = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JCustomBodyEnd',
    NULL,
    NULL,
  ...
  $JBirthDay = new Snowfox_Widget_Helper_Form_Element_Text(
    'JBirthDay',
    NULL,
    NULL,
    '网站成立日期（非必填）',
  ...
  $JCustomFont = new Snowfox_Widget_Helper_Form_Element_Text(
    'JCustomFont',
    NULL,
    NULL,
    '自定义网站字体（非必填）',
  ...
  $JCustomAvatarSource = new Snowfox_Widget_Helper_Form_Element_Text(
    'JCustomAvatarSource',
    NULL,
    NULL,
    '自定义头像源（非必填）',
  ...
  $JAside_Author_Nick = new Snowfox_Widget_Helper_Form_Element_Text(
    'JAside_Author_Nick',
    NULL,
    "Snowfox",
    '博主栏博主昵称 - PC/WAP',
  ...
  /* --------------------------------------- */
  $JAside_Author_Avatar = new Snowfox_Widget_Helper_Form_Element_Textarea(
  ...
  /* --------------------------------------- */
  $JAside_Author_Image = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JAside_Author_Image',
    NULL,
    "https://npm.elemecdn.com/Snowfox-joe-latest/assets/img/aside_author_image.jpg",
    '博主栏背景壁纸 - PC',
  ...
  /* --------------------------------------- */
  $JAside_Wap_Image = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JAside_Wap_Image',
    NULL,
    "https://npm.elemecdn.com/Snowfox-joe-latest/assets/img/wap_aside_image.jpg",
    '博主栏背景壁纸 - WAP',
  ...
  /* --------------------------------------- */
  $JAside_Author_Link = new Snowfox_Widget_Helper_Form_Element_Text(
    'JAside_Author_Link',
    NULL,
    "https://78.al",
    '博主栏昵称跳转地址 - PC/WAP',
  ...
  /* --------------------------------------- */
  $JAside_Author_Motto = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JAside_Author_Motto',
    NULL,
    "有钱终成眷属，没钱亲眼目睹",
    '博主栏座右铭（一言）- PC/WAP',
  ...
  /* --------------------------------------- */
  $JAside_Author_Nav = new Snowfox_Widget_Helper_Form_Element_Select(
    'JAside_Author_Nav',
    array(
      'off' => '关闭（默认）',
      '3' => '开启，并显示3条最新文章',
  ...
  /* --------------------------------------- */
  $JAside_Timelife_Status = new Snowfox_Widget_Helper_Form_Element_Select(
  ...
  /* --------------------------------------- */
  $JAside_Hot_Num = new Snowfox_Widget_Helper_Form_Element_Select(
    'JAside_Hot_Num',
    array(
      'off' => '关闭（默认）',
      '3' => '显示3条',
  ...
  /* --------------------------------------- */
  $JAside_Newreply_Status = new Snowfox_Widget_Helper_Form_Element_Select(
  ...
  /* --------------------------------------- */
  $JAside_Weather_Key = new Snowfox_Widget_Helper_Form_Element_Text(
    'JAside_Weather_Key',
    NULL,
    NULL,
    '天气栏KEY值 - PC',
  ...
  /* --------------------------------------- */
  $JAside_Weather_Style = new Snowfox_Widget_Helper_Form_Element_Select(
  ...
  /* --------------------------------------- */
  $JADContent = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JADContent',
    NULL,
    NULL,
    '侧边栏广告 - PC',
  ...
  /* --------------------------------------- */
  $JCustomAside = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JCustomAside',
    NULL,
    NULL,
    '自定义侧边栏模块 - PC',
  ...
  /* --------------------------------------- */
  $JAside_3DTag = new Snowfox_Widget_Helper_Form_Element_Select(
    'JAside_3DTag',
    array(
      'off' => '关闭（默认）',
      'on' => '开启'
  ...
  /* --------------------------------------- */
  $JAside_Flatterer = new Snowfox_Widget_Helper_Form_Element_Select(
    'JAside_Flatterer',
    array(
      'off' => '关闭（默认）',
      'on' => '开启'
  ...
  /* --------------------------------------- */
  $JAside_History_Today = new Snowfox_Widget_Helper_Form_Element_Select(
  ...
  $JThumbnail = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JThumbnail',
    NULL,
    NULL,
    '自定义缩略图',
  ...
  $JLazyload = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JLazyload',
    NULL,
    "https://npm.elemecdn.com/Snowfox-joe-latest/assets/img/lazyload.jpg",
    '自定义懒加载图',
    '介绍：用于修改主题默认懒加载图 <br/>
         格式：图片地址'
  );
  ...
  $JDynamic_Background = new Snowfox_Widget_Helper_Form_Element_Select(
    'JDynamic_Background',
    array(
      'off' => '关闭（默认）',
      'backdrop1.js' => '效果1',
  ...
  $JWallpaper_Background_PC = new Snowfox_Widget_Helper_Form_Element_Textarea(
  ...
  $JWallpaper_Background_WAP = new Snowfox_Widget_Helper_Form_Element_Textarea(
  ...
  $JIndex_Carousel = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JIndex_Carousel',
    NULL,
    NULL,
    '首页轮播图',
  ...
  $JIndex_Recommend = new Snowfox_Widget_Helper_Form_Element_Text(
    'JIndex_Recommend',
    NULL,
    NULL,
  ...
  $JIndexSticky = new Snowfox_Widget_Helper_Form_Element_Text(
    'JIndexSticky',
    NULL,
    NULL,
    '首页置顶文章（非必填）',
  ...
  $JIndex_Hot = new Snowfox_Widget_Helper_Form_Element_Radio(
    'JIndex_Hot',
  ...
  $JIndex_Ad = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JIndex_Ad',
    NULL,
    NULL,
    '首页大屏广告',
  ...
  $JIndex_Notice = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JIndex_Notice',
    NULL,
    NULL,
    '首页通知文字（非必填）',
  ...
  $JFriends = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JFriends',
    NULL,
    'Joe的博客 || https://78.al || https://npm.elemecdn.com/Snowfox-joe-latest/assets/img/link.png || Eternity is not a distance but a decision',
    '友情链接（非必填）',
    '介绍：用于填写友情链接 <br />
  ...
  $JMaccmsAPI = new Snowfox_Widget_Helper_Form_Element_Text(
    'JMaccmsAPI',
    NULL,
    NULL,
    '苹果CMS开放API',
  ...
  $JCustomPlayer = new Snowfox_Widget_Helper_Form_Element_Text(
    'JCustomPlayer',
    NULL,
    NULL,
    '自定义视频播放器（非必填）',
  ...
  $JSensitiveWords = new Snowfox_Widget_Helper_Form_Element_Textarea(
    'JSensitiveWords',
    NULL,
    '你妈死了 || 傻逼 || 操你妈 || 射你妈一脸',
    '评论敏感词（非必填）',
  ...
  $JLimitOneChinese = new Snowfox_Widget_Helper_Form_Element_Select(
    'JLimitOneChinese',
    array('off' => '关闭（默认）', 'on' => '开启'),
    'off',
    '是否开启评论至少包含一个中文',
  ...
  $JTextLimit = new Snowfox_Widget_Helper_Form_Element_Text(
    'JTextLimit',
    NULL,
    NULL,
    '限制用户评论最大字符',
  ...
  $JSiteMap = new Snowfox_Widget_Helper_Form_Element_Select(
    'JSiteMap',
    array(
      'off' => '关闭（默认）',
      '100' => '显示最新 100 条链接',
  ...
  $JBTPanel = new Snowfox_Widget_Helper_Form_Element_Text(
    'JBTPanel',
    NULL,
    NULL,
    '宝塔面板地址',
  ...
  $JBTKey = new Snowfox_Widget_Helper_Form_Element_Text(
    'JBTKey',
    NULL,
    NULL,
    '宝塔开放接口密钥',
  ...
  /* 评论发信 */
  $JCommentMail = new Snowfox_Widget_Helper_Form_Element_Select(
    'JCommentMail',
    array('off' => '关闭（默认）', 'on' => '开启'),
    'off',
    '是否开启评论邮件通知',
  ...
  $JCommentMailHost = new Snowfox_Widget_Helper_Form_Element_Text(
    'JCommentMailHost',
    NULL,
    NULL,
    '邮箱服务器地址',
  ...
  $JCommentSMTPSecure = new Snowfox_Widget_Helper_Form_Element_Select(
    'JCommentSMTPSecure',
  ...
  $JCommentMailPort = new Snowfox_Widget_Helper_Form_Element_Text(
    'JCommentMailPort',
    NULL,
    NULL,
    '邮箱服务器端口号',
  ...
  $JCommentMailFromName = new Snowfox_Widget_Helper_Form_Element_Text(
  ...
  $JCommentMailAccount = new Snowfox_Widget_Helper_Form_Element_Text(
    'JCommentMailAccount',
    NULL,
    NULL,
    '发件人邮箱',
  ...
  $JCommentMailPassword = new Snowfox_Widget_Helper_Form_Element_Text(
  ...
  $JBaiduToken = new Snowfox_Widget_Helper_Form_Element_Text(
    'JBaiduToken',
    NULL,
    NULL,
    '百度推送Token',
  ...
  $JOverdue = new Snowfox_Widget_Helper_Form_Element_Select(
    'JOverdue',
    array(
      'off' => '关闭（默认）',
      '3' => '大于3天',
  ...
  $JEditor = new Snowfox_Widget_Helper_Form_Element_Select(
    'JEditor',
    array(
      'on' => '开启（默认）',
      'off' => '关闭',
  ...
  $JPrismTheme = new Snowfox_Widget_Helper_Form_Element_Select(
    'JPrismTheme',
    array(
