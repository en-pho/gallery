...
<head>
  ...
  <link href="<?php _getAssets('assets/css/joe.census.min.css'); ?>" rel="stylesheet">
  <script src="<?php _getAssets('assets/lib/echarts@5.4.0/echarts.min.js'); ?>"></script>
  <script src="<?php _getAssets('assets/js/joe.census.min.js'); ?>"></script>
</head>
...
<body>
  <div id="Joe">
    ...
    <div class="joe_container">
      <div class="joe_main">
        <?php Snowfox_Widget::widget('Widget_Stat')->to($item); ?>
