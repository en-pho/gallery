...
<script>
  <?php
  $cookie = Snowfox_Cookie::getPrefix();
  $notice = $cookie . '__Snowfox_notice';
  $type = $cookie . '__Snowfox_notice_type';
  ?>
  ...
  <?php endif; ?>
  <?php
  Snowfox_Cookie::delete('__Snowfox_notice');
  Snowfox_Cookie::delete('__Snowfox_notice_type');
  ?>
