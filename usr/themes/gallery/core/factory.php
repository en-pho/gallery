...
/* 加强评论拦截功能 */
Snowfox_Plugin::factory('Widget_Feedback')->comment = array('Intercept', 'message');
class Intercept
{
  public static function message($comment)
  {
    ...
    Snowfox_Cookie::delete('__Snowfox_remember_text');
    return $comment;
  }
}
...
if (
  ...
  Snowfox_Plugin::factory('Widget_Feedback')->finishComment = array('Email', 'send');
}
...
if (Helper::options()->JEditor !== 'off') {
  Snowfox_Plugin::factory('admin/write-post.php')->richEditor  = array('Editor', 'Edit');
  Snowfox_Plugin::factory('admin/write-page.php')->richEditor  = array('Editor', 'Edit');
}
...
?>
    ...
    <link href="<?php _getAssets('assets/Snowfox/write/css/joe.write.min.css') ?>" rel="stylesheet" />
    <script>
      window.JoeConfig = {
        uploadAPI: '<?php Helper::security()->index('/action/upload'); ?>',
        emojiAPI: '<?php _getAssets('assets/Snowfox/write/json/emoji.json') ?>',
        expressionAPI: '<?php _getAssets('assets/Snowfox/write/json/expression.json') ?>',
        characterAPI: '<?php _getAssets('assets/Snowfox/write/json/character.json') ?>',
    ...
    <script src="<?php _getAssets('assets/Snowfox/write/parse/parse.min.js') ?>"></script>
    <script src="<?php _getAssets('assets/Snowfox/write/dist/index.bundle.js') ?>"></script>
